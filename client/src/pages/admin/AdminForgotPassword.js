    ...
    <div className="min-h-screen bg-[#050507] pt-28 pb-16 px-4">
      ...
      >
        ...
        <div className="p-6 sm:p-8 lg:p-10">
          ...
          <p className="mt-6 text-xs uppercase tracking-[0.28em] text-purple-300/80 font-semibold">Admin Password Help</p>
          <h1 className="mt-3 text-4xl font-black text-white">Forgot Admin Password</h1>
          <p className="mt-3 text-sm leading-7 text-gray-400">
            Enter your admin email address and we&apos;ll send a secure reset link.
          </p>
            ...
            <div>
              ...
              <div className="relative mt-2">
                ...
                <input
                  ...
                  className="w-full rounded-2xl border border-white/10 bg-white/5 py-4 pl-12 pr-4 text-white outline-none focus:border-purple-400/50"
