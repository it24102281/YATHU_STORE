              ...
              {orders.map((order) => (
                <div key={order.id} className="rounded-3xl border border-white/8 bg-white/[0.03] p-5 sm:p-6">
                  <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
                    <div>
                      <p className="text-xs uppercase tracking-[0.24em] text-gray-500 font-semibold">Order ID</p>
                    ...
                    <div className="text-left md:text-right">
                      <p className="text-xs uppercase tracking-[0.24em] text-gray-500 font-semibold">Price</p>
                      <p className="mt-2 text-3xl font-black text-white">LKR {order.price}</p>
