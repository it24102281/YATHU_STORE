    ...
    <div className="min-h-screen bg-[#050507] pt-28 pb-16 px-4">
      <motion.div initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} className="max-w-xl mx-auto rounded-[32px] border border-white/10 bg-[#09090d]/85 backdrop-blur-2xl shadow-[0_24px_80px_rgba(0,0,0,0.5)] overflow-hidden">
        ...
        <div className="p-6 sm:p-8 lg:p-10">
          ...
          <h1 className="mt-3 text-4xl font-black text-white">Reset Password</h1>
          ...
          <form onSubmit={handleSubmit} className="mt-8 space-y-5">
            <div>
              ...
              <div className="relative mt-2">
                ...
                <input type={showPassword ? 'text' : 'password'} value={password} onChange={(e) => setPassword(e.target.value)} className="w-full rounded-2xl border border-white/10 bg-white/5 py-4 pl-12 pr-14 text-white outline-none focus:border-purple-400/50" placeholder="Enter new password" />
            ...
            <div>
              ...
              <div className="relative mt-2">
                <Lock className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-500" />
                <input type={showConfirmPassword ? 'text' : 'password'} value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} className="w-full rounded-2xl border border-white/10 bg-white/5 py-4 pl-12 pr-14 text-white outline-none focus:border-purple-400/50" placeholder="Confirm new password" />
